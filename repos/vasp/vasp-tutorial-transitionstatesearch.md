...
(source: vasp-tutorial-transitionstatesearch.html)
...
You may use a script like in the [https://vasp.at/tutorials/latest/transition_states/part1/#transition_states-e01 tutorial on self-diffusion of a Si atom to a vacancy site] or develop your own method.
...
You should also set IBRION, ISIF, NSW, and other relaxation-related tags.
...
The NEB feature presented here cannot be applied to structural transitions. Changing the lattice would require a different algorithm referred to as variable-cell NEB that is not available within VASP.
For more advanced calculations, consider using the [https://theory.cm.utexas.edu/vtsttools/index.html Transition State Tools for VASP (VTST)].

== Related tags and articles ==
IMAGES, IMAGE_1, SPRING, IBRION

[https://vasp.at/tutorials/latest/transition_states/part1/#transition_states-e01 Tutorial on self-diffusion of a Si atom to a vacancy site]
...
Category:Transition statesCategory:Ionic minimizationCategory:Howto
