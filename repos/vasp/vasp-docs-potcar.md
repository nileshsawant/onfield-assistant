...
* Guide on recommendations:  Choosing pseudopotentials.
 The settings in the POTCAR file are read-only and must not be edited.
...
The information below is not complete. However, we believe that it covers the most information required in practice. Some other tags are also documented in the POTCAR file itself.
...
You may choose this string to indicate what pseudopotential you have used in your publication to ensure the reproducibility of your results.|:
; LEXCH
