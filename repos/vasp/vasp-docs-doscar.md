...
*vasp.4.5,  NPAR\ne1  no site projected DOS
*vasp.4.6,  NPAR\ne1, LORBIT=0-5 no site projected DOS
...
For relaxations, the DOSCAR is usually useless. If you want to get an accurate DOS for the final configuration, first copy CONTCAR to POSCAR and continue with one static (1; 0) calculation. Mind that for NSW>1 the final DOS is averaged of all ionic steps. See KBLOCK for details.

----

Category:FilesCategory:Output filesCategory:Density of states
